var WebSqlStore = function(successCallback, errorCallback) {
    ...
    this.addSampleData = function(tx, employees) {
        var employees = [
                ...
                {"id": 15, "firstName": "Frank", "lastName": "Koeble", "title":"Agile Dude", "managerId": 1, "city":"Stuttgart, BW", "cellPhone":"123-321-0001", "officePhone":"123-321-1023", "email":"agile@dundermifflin.com"}
            ];
